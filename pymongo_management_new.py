...
async def claim_pending_commands_to_json(
    ...
    base_filter = {
        ...
        "$or": [
            ...
            {
                "Status": "Đã cho vào hàng chờ để đăng lại",
...
def command_doc_to_job(cmd: dict) -> dict:
    ...
    job = {
        ...
        "auto_join_if_needed": params.get("auto_join_if_needed", False),
    }
    return job
#-------------------------------------------------------------------------------------------------------------------------------
...
async def update_statusFB(username=None, account=None, statusFB=None, device_id=None, device_name=None):
    """
    Cập nhật trạng thái Facebook của tài khoản trên thiết bị.
